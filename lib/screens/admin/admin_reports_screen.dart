          ...
          child: Column(
            ...
            children: [
              ...
              _buildReportSection(
                ...
                Colors.blue,
                [
                  _buildReportItem('Total de Usuários', _reportData['userReports']?['totalUsers'] ?? '0', '+12%'),
                  _buildReportItem('Usuários Online', _reportData['userReports']?['onlineUsers'] ?? '0', '+8%'),
                  _buildReportItem('Novos Registros', _reportData['userReports']?['newRegistrations'] ?? '0', '+23%'),
                  _buildReportItem('Usuários Banidos', _reportData['userReports']?['bannedUsers'] ?? '0', '-2%'),
                ],
              ),
              const SizedBox(height: 20),
              _buildReportSection(
                ...
                Colors.green,
                [
                  _buildReportItem('Mensagens Enviadas', _reportData['activityReports']?['messagesSent'] ?? '0', '+15%'),
                  _buildReportItem('Chamadas Realizadas', _reportData['activityReports']?['callsMade'] ?? '0', '+7%'),
                  _buildReportItem('Tempo Médio Online', _reportData['activityReports']?['avgOnlineTime'] ?? 'N/A', '+5%'),
                  _buildReportItem('Canais Criados', _reportData['activityReports']?['channelsCreated'] ?? 'N/A', '+12%'),
                ],
              ),
              ...
              _buildReportSection(
                ...
                Colors.purple,
                [
                  _buildReportItem('Total de Federações', _reportData['organizationReports']?['totalFederations'] ?? '0', '+1'),
                  _buildReportItem('Total de Clãs', _reportData['organizationReports']?['totalClans'] ?? '0', '+8'),
                  _buildReportItem('Clãs Ativos', _reportData['organizationReports']?['activeClans'] ?? '0', '+5'),
                  _buildReportItem('Média de Membros/Clã', _reportData['organizationReports']?['avgMembersPerClan'] ?? 'N/A', '+2.1'),
                ],
              ),
              const SizedBox(height: 20),
