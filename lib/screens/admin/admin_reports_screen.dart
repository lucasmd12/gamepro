          ...
          child: Column(
            ...
            children: [
              ...
              _buildReportSection(
                ...
                Colors.blue,
                [
                  _buildReportItem('Total de Usuários', (_reportData['userReports']?['totalUsers']?.toString() ?? '0'), '+12%'),
                  _buildReportItem('Usuários Online', (_reportData['userReports']?['onlineUsers']?.toString() ?? '0'), '+8%'),
                  _buildReportItem('Novos Registros', (_reportData['userReports']?['newRegistrations']?.toString() ?? '0'), '+23%'),
                  _buildReportItem('Usuários Banidos', (_reportData['userReports']?['bannedUsers']?.toString() ?? '0'), '-2%'),
                ],
              ),
              ...
              _buildReportSection(
                ...
                [
                  _buildReportItem('Mensagens Enviadas', (_reportData['activityReports']?['messagesSent']?.toString() ?? '0'), '+15%'),
                  _buildReportItem('Chamadas Realizadas', (_reportData['activityReports']?['callsMade']?.toString() ?? '0'), '+7%'),
                  _buildReportItem('Tempo Médio Online', (_reportData['activityReports']?['avgOnlineTime']?.toString() ?? 'N/A'), '+5%'),
                  _buildReportItem('Canais Criados', (_reportData['activityReports']?['channelsCreated']?.toString() ?? 'N/A'), '+12%'),
                ],
              ),
              const SizedBox(height: 20),
              _buildReportSection(
                ...
                Colors.purple,
                [
                  _buildReportItem('Total de Federações', (_reportData['organizationReports']?['totalFederations']?.toString() ?? '0'), '+1'),
                  _buildReportItem('Total de Clãs', (_reportData['organizationReports']?['totalClans']?.toString() ?? '0'), '+8'),
                  _buildReportItem('Clãs Ativos', (_reportData['organizationReports']?['activeClans']?.toString() ?? '0'), '+5'),
                  _buildReportItem('Média de Membros/Clã', (_reportData['organizationReports']?['avgMembersPerClan']?.toString() ?? 'N/A'), '+2.1'),
                ],
              ),
              const SizedBox(height: 20),
              _buildReportSection(
                ...
                Colors.orange,
                [
                  _buildReportItem('Uptime do Servidor', (_reportData['systemReports']?['serverUptime']?.toString() ?? 'N/A'), '+0.2%'),
                  _buildReportItem('Uso de CPU', (_reportData['systemReports']?['cpuUsage']?.toString() ?? 'N/A'), '-5%'),
                  _buildReportItem('Uso de Memória', (_reportData['systemReports']?['memoryUsage']?.toString() ?? 'N/A'), '+3%'),
                  _buildReportItem('Armazenamento', (_reportData['systemReports']?['storageUsed']?.toString() ?? 'N/A'), '+12 GB'),
                ],
              ),
              const SizedBox(height: 24),
              Row(
