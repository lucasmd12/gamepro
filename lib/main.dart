  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        // PermissionService removido para resolver dependência circular.
        // Deve ser instanciado sob demanda nas telas que o utilizam.
        ...
        // [CORRIGIDO] Fornecendo a instância singleton do CacheService
        Provider<CacheService>.value(
          value: CacheService.instance,
        ),
        // [CORRIGIDO] Passando as dependências corretas para o SyncService
      ...
      child: AppLifecycleReactor(
        // [CORRIGIDO] Passando o MaterialApp como filho para o IncomingCallOverlay
            ...
            home: Consumer<AuthProvider>(
              builder: (context, authProvider, _) {
                if (authProvider.authStatus == AuthStatus.unknown) {
                  ...
                  // Redireciona para o painel de admin se o usuário for admMaster
