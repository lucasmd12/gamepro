  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        Provider<StatsService>(create: (context) => StatsService(context.read<ApiService>())),
      ],
      child: AppLifecycleReactor(
        child: MaterialApp(
          ...
          routes: {
            ...
            '/admin-manage-users': (context) => const AdminUserManagementScreen(),
          },
        ),
      ),
    );
...
import 'package:instacladedicadopronto/services/stats_service.dart';
...
import 'screens/admin/admin_system_settings_screen.dart';
            ...
            '/admin-organization-management': (context) => const AdminOrganizationManagementScreen(),
